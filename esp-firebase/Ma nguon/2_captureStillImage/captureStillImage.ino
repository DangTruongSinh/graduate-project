...
const char *ssid = "trung"; // Put your SSID here
const char *password = "trung123"; // Put your PASSWORD here

static IPAddress ip(192, 168, 1, 123); // static IP used for browser access: http://IPaddress
...
void handleNotFound() {
  ...
  else
  {
    ...
    for (int i = 1; i <= fileCount; i++)
    {
      ...
      urlhinh = "http://"+ ipStr + "/pics/" + i + ".jpg";
      Firebase.setString("url", urlhinh);
      colCnt++;
...
void setup() {
  ...
  Firebase.setFloat("nhietdo", 100);

  Serial.println( Firebase.getString("khoa"));
  
  //  obj["ten chanel:"] = String("doantotnghiep");
  //  Serial.println("tai day 5");
  //  Firebase.stream("/khoa");
  //  Firebase.setString("khoa", "off");
  //  Serial.println("tai day 6");
