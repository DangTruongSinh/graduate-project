...
void I2C_Configuration(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin =  GPIO_Pin_6 | GPIO_Pin_7;  //配置I2C1 SDA SCL Pin
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;		     //管脚频率为50MHZ
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_OD;		       //模式为复用开漏输出
  GPIO_Init(GPIOB, &GPIO_InitStructure);				   
	
  					     
  I2C_InitStructure.I2C_Mode = I2C_Mode_I2C;		             //I2C模式
  I2C_InitStructure.I2C_DutyCycle = I2C_DutyCycle_2;         //占空比50%
  I2C_InitStructure.I2C_OwnAddress1 = I2C1_SLAVE_ADDRESS7;	 //本地地址(0xA0)使能应答
...
***************************************************/
void I2C_EE_BufferWrite(u16* pBuffer, uint8_t WriteAddr, uint16_t NumByteToWrite)
{
...
***************************************************/
void I2C_EE_ByteWrite(u16* pBuffer, uint8_t WriteAddr)
{
...
***************************************************/
void I2C_EE_PageWrite(u16* pBuffer, uint8_t WriteAddr, uint8_t NumByteToWrite)
{
...
*功能说明:读取EEPROM的页数据
***************************************************/
u16 I2C_EE_BufferRead(u16* pBuffer, uint8_t ReadAddr, uint16_t NumByteToRead)
{  
