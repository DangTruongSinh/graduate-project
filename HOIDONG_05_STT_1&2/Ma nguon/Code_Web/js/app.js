    ...
    'render': {
        ...
        'message': function (message) {
            ...
            var html = '<li class="messLine id="' + largest + '">' +
                ...
                '           <div class="large-5 columns topicM truncate" id="topicM' + largest + '" title="' + Encoder.htmlEncode(message.topic, 0) + '">Máy chấm công: ' + Encoder.htmlEncode(message.topic) + '</div>' +
